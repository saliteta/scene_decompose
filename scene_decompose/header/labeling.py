...
class FeatureLabeler:
    ...
    def label_from_file(self, feature_path: str, output_path: str = None) -> torch.Tensor:
        """
        ...
        features = self.load_features("/data0/vpr/CUHK_LOWER/ckpts/ckpt_6998_rank0features.pt")
        features_1 = self.load_features("/data0/vpr/CUHK_LOWER/ckpts/ckpt_6998_rank0features1.pt")
...
def main():
    parser = argparse.ArgumentParser(description="Generate labels from features using trained head")
    parser.add_argument("--features", type=str, required=True, 
                       help="Path to input feature file (n×c channels)")
    parser.add_argument("--checkpoint", type=str, default="best_patch_head.pth",
                       help="Path to head checkpoint file")
    parser.add_argument("--output", type=str, default=None,
                       help="Path to save output labels")
